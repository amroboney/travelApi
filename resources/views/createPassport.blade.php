            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('passport.store') }}">
                        ...
                        <div class="row mb-3">
                            <label for="nationalty" class="col-md-4 col-form-label text-md-end">{{ __('Nationalty') }}</label>

                            <div class="col-md-6">
                                <input id="nationalty" type="nationalty" class="form-control @error('nationalty') is-invalid @enderror" name="nationalty" value="{{ old('nationalty') }}" required autocomplete="nationalty">
